                ...
                <form action="/app/plan/add" method="post">
                    ...
                    <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="planName" name="planName" placeholder="Nazwa planu" minlength="4">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="5" id="planDescription"
                                          placeholder="Opis planu" name="planDescription" minlength="4" maxlength="255"></textarea>
                            </div>
                        </div>
