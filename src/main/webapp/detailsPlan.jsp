            ...
            <div class="dashboard-content border-dashed p-3 m-4">
                ...
                <div class="schedules-content">
                    ...
                    <table class="table">
                        <thead>
                        <tr class="d-flex">
                            <th class="col-2" id="dayId">${map.key}</th>
                            <th class="col-7"></th>
                            <th class="col-1"></th>
                            <th class="col-2"></th>
                        </tr>
                        ...
                        <tr class="d-flex">
                            <td class="col-2">${map.value[0]}</td>
                            <td class="col-7">${map.value[1]}</td>
                            <td class="col-1 center">
                                <a href="<c:url value="/app/recipe/plan/delete"><c:param name="recipeId" value="${map.value[3]}"/></c:url>" onclick="return confirm('Jestes pewien ze chcesz usunac?')" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                            </td>
                            <td class="col-2 center">
                                <a href="<c:url value="/app/recipes/details"><c:param name="recipeId" value="${map.value[4]}"/></c:url>" class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
                            </td>
                        </tr>
                        </tbody>
                        </c:forEach>
