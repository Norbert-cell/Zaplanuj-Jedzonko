                    ...
                    <table class="table border-bottom">
                        ...
                        <c:forEach items="${planList}" var="plan">
                            ...
                            <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                <a onclick="return confirm('Jestes pewien ze chcesz usunac?')" href="<c:url value="/app/plan/delete"><c:param name="planId" value="${plan.id}"/></c:url>" id="delete" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                <a href="<c:url value="/app/plan/details"><c:param name="planId" value="${plan.id}"/></c:url>"  class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
                                <a href="<c:url value="/app/plan/edit"><c:param name="planId" value="${plan.id}"/></c:url>" class="btn btn-warning rounded-0 text-light m-1">Edytuj</a>
                            </td>
                            </tr>
                        </c:forEach>
                        </tbody>
