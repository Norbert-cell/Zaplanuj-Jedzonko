            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <form method="post" action="/app/plan/edit">
                    ...
                    <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            <label for="planDescription" class="col-sm-2 label-size col-form-label" value="${plan.description}" >
                                Opis planu
                            </label>
                            <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" id="planDescription" name="planDescription" placeholder="Opis planu">${plan.description}
                                    </textarea>
                            </div>
                        </div>
