...
<head>
    ...
    <script defer src="../search.js" type="text/javascript" crossorigin="anonymous"></script>
...
<section class="mr-4 ml-4">
            ...
            <div class="row">
                <div class="col">
                    <div class="input-group mb-3 center">
                        <h3 class="mb-4">Wyszukaj po nazwie: </h3>
                            <input type="search" class="border-0 rounded-0 ui-corner-left form-control" placeholder="Wyszukaj po nazwie"
                                   aria-label="Recipient's username" aria-describedby="basic-addon2" id="inputRecipe">
                    </div>
                </div>
            </div>
        </div>
    ...
    <table class="table">
        ...
        <tbody class="text-color-lighter" id="tbody">
<%--                <c:forEach items="${allRecipe}" var="recipe">--%>
<%--                <tr class="d-flex" id="recipeBody">--%>
